...
class image_converter:
	def __init__(self):
		...
		GMMin = 'Final_Yellow_GMM_BGR_3.npz'
		...
		filename = 'Final_middlevals_YellowWindow.npy'
		#filename = 'MaroonWindow_2.npy'
		thresh_single  = .05#1e-4 # threshold for Maroon
	...
	def callback(self,data,args):
		...
		cv_image_cc_blur = cv2.medianBlur(cv_image_cc,7)
